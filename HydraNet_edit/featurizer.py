...
class InputFeature(object):
    ...
    def output_SQ(self, agg=None, sel=None, conditions=None, return_str=True):
        ...
        for wc, op, vs, ve in conditions:
            ...
            char_end = len(self.question) if word_end + 1 >= len(self.word_to_char_start) else self.word_to_char_start[
                word_end + 1]
...
class HydraFeaturizer(object):
    ...
    def load_data(self, data_paths: str, config: Dict, include_label: bool=False):
        ...
        for data_path in data_paths.split("|"):
            ...
            for line in open(data_path, encoding="utf8"):
                ...
                if "DEBUG" in config and cnt > 100:
                    break
        print('# of value out of span '+str(cnt_value_out_of_span))
