...
class HydraEvaluator():
    def __init__(self, output_path, config, hydra_featurizer: HydraFeaturizer, model:BaseModel, note="", train_eval = None):
        self.config = config
        self.model = model
        ...
        # self.eval_data['train_eval'] = train_eval

        # print("Eval Data file {0} loaded, sample num = {1}".format('train_eval', len(train_eval)))
